...
export const heroMistpeakOne = {
  ...
  description: [
    ...
    'Part One (Act I and II) is available for free on Apple Books and Google Play Store. Part Two (Act III and IV) is scheduled for release in 2025, while Part Three, with the final Acts V and VI, will follow in 2028.',
    'The future will reveal itself when it is ready to do so.',
  ],
  locale: 'en-GB',
  ...
  links: {
    ...
    kindle: null,
    apple: 'https://books.apple.com/book/id6474696139',
