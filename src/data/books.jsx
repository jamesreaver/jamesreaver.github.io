...
import coverHeroMistpeak from '@/images/books/hero-of-mistpeak.png'
...
export const romoloTucano = {
  title: 'Romolo Tucano: Odiosi i Parenti!',
  subtitle: 'Episodio 1',
...
export const russelToucan = {
  title: 'Russel Toucan: Despicable Relatives!',
  subtitle: 'Episode 1',
...
export const heroMistpeak = {
  ...
  subtitle: 'Part One',
  synopsis: 'At the dawn of the industrial revolution, young Prince of Albion Elliot is promised to the son of the foreign King of Samarkand. Still his heart burns for a mysterious girl he met on a mission, a journey which will spark a heinous war amongst all nations.',
  description: [
